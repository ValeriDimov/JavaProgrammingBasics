...
//5.	Броят на палачинките – цяло число в интервала [0 … 2000]
        ...
        int chiefs = Integer.parseInt(scanner.nextLine());
...
//Сума след покриване на разходите: 157356.8 - 1/8 от 157356.8 = 137687.2 лв.
        ...
        double cakesPrise = cakes * 45;
        double wafflesPrise = waffles * 5.80;
        double pancakesPrise = pancakes * 3.20;
        double oneDayProd = (cakesPrise + wafflesPrise + pancakesPrise) * chiefs;
        double totalProd = oneDayProd * days;
        double donation = totalProd - (totalProd / 8);
